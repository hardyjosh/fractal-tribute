...
<div class="flex gap-x-2 mb-4 items-center justify-between">
  ...
  <div class="flex items-center gap-x-6">
    ...
    <Button
      size="lg"
      href="https://github.com/holochain-apps/fractal-tribute-kangaroo/releases/download/v0.1.2/fractal-tribute_0.1.2_universal.dmg"
      class="bg-fractalorange border-2 border-black">Download for Mac</Button
    >
    <Button
      size="lg"
      href="https://github.com/holochain-apps/fractal-tribute-kangaroo/releases/download/v0.1.2/fractal-tribute_0.1.2_x64-setup.exe"
